...
def chat_completion(request: ChatRequest):
    ...
    try:
        ...
        tool_messages, tool_results = check_and_run_tools(messages_list, MODEL_NAME, session)
        ...
        log_info(session, f"Session Summary: Total LLM Calls: 2 | Executed Tool Calls: {executed_tools}")
        return response
    except Exception as e:
